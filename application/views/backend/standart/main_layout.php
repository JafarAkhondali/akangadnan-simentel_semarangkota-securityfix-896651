...
<head>
	...
	<script type="text/javascript">
		...
		var ADMIN_BASE_URL 	= "<?= base_url();?>administrator";
...
<body class="sidebar-mini skin-blue-light fixed web-body">
	...
	?>
			...
			<a href="<?= site_url('/'); ?>" class="logo" target="blank">
				<span class="logo-mini"><b><img src="<?= BASE_ASSET ?>img/Logo-Kota-Semarang.png" height="40px"></b></span>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2017-<?= date('Y'); ?> <a href="<?= site_url(); ?>" target="blank"><?= get_option('site_name'); ?></a>.</strong> All rights reserved.
		</footer>
	</div>
