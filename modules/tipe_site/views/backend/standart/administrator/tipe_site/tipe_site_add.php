...
<section class="content-header">
	<h1>Tipe Site <small><?= cclang('new', ['Tipe Site']); ?> </small></h1>
	<ol class="breadcrumb">
		<li><a href="javascript:void(0);"><i class="fa fa-dashboard"></i> Home</a></li>
		<li><a href="<?= admin_site_url('/tipe_site'); ?>">Tipe Site</a></li>
		...
		<div class="col-md-12">
			<div class="box box-primary">
				...
				<div class="box-header">
					<h3 class="box-title"><?= cclang('new', ['Tipe Site']); ?></h3>
				</div>
				<div class="box-body">
					<div class="form-group group-tipe-site-nama">
						<label for="tipe_site_nama" class="control-label">Tipe Site <i class="required">*</i></label>
						<input type="text" class="form-control" name="tipe_site_nama" id="tipe_site_nama" placeholder="Tipe Site" value="<?= set_value('tipe_site_nama'); ?>">
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$('#btn_cancel').click(function () {
			...
			function (isConfirm) {
				if (isConfirm) {
					window.location.href = ADMIN_BASE_URL + '/tipe_site';
				}
			});
		...
		$('.btn_save').click(function () {
			...
			$.ajax({
				url: ADMIN_BASE_URL + '/tipe_site/add_save',
				type: 'POST',
				dataType: 'json',
				data: data_post,
			})
