...
<body class="hold-transition login-page">
	<div class="login-box">
		<div class="login-logo">
			...
			<a href="javascript:void(0);">
				<img src="<?= BASE_ASSET;?>img/SiMenTel-biru.png" class="img-responsive">
			</a>
		</div>
		<div class="login-box-body">
			<p class="login-box-msg"><?= cclang('login'); ?> Administrator <?= get_option('site_name'); ?></p>
	...
	<script type="text/javascript" src="<?= BASE_ASSET ?>admin-lte/plugins/jQuery/jquery-3.6.0.min.js"></script>
