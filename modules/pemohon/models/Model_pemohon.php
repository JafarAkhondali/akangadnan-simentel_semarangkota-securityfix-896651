...
class Model_pemohon extends MY_Model {
    ...
    public $field_search   = ['pemohon_nama', 'pemohon_alamat', 'kecamatan_id', 'kelurahan_id', 'kecamatan.kecamatan_nama', 'kelurahan.kelurahan_nama', 'agama.agama_nama'];
