...
<section class="content-header">
	<h1>Agama <small><?= cclang('new', ['Agama']); ?> </small></h1>
	<ol class="breadcrumb">
		<li><a href="javascript:void(0);"><i class="fa fa-dashboard"></i> Home</a></li>
		<li><a href="<?= admin_site_url('/agama'); ?>">Agama</a></li>
		...
		<div class="col-md-12">
			...
			?>
				<div class="box-header">
					<h3 class="box-title"><?= cclang('new', ['Agama']); ?></h3>
				</div>
				<div class="box-body">
					<div class="form-group group-agama-nama">
						<label for="agama_nama" class="control-label">Nama Agama <i class="required">*</i></label>
						<input type="text" class="form-control" name="agama_nama" id="agama_nama" placeholder="Nama Agama" value="<?= set_value('agama_nama'); ?>">
...
<script>
	$(document).ready(function () {
		...
		$('#btn_cancel').click(function () {
			...
			function (isConfirm) {
				if (isConfirm) {
					window.location.href = ADMIN_BASE_URL + '/agama';
				}
			});
		...
		$('.btn_save').click(function () {
			...
			$.ajax({
				url: ADMIN_BASE_URL + '/agama/add_save',
				type: 'POST',
				dataType: 'json',
				data: data_post,
			})
