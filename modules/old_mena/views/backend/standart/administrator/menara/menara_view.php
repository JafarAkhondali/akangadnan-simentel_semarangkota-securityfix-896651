            ...
            <div class="box-body ">
               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="form-horizontal form-step" name="form_menara" id="form_menara" >
                    ...
                    <div class="form-group ">
                        <label for="content" class="col-sm-2 control-label">Operator Id </label>

                        <div class="col-sm-8">
                           <?= _ent($menara->operator_operator_nama); ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group ">
                        <label for="content" class="col-sm-2 control-label">Ketinggian </label>
                    ...
                    <div class="form-group ">
                        <label for="content" class="col-sm-2 control-label">Luas Area Menara </label>
                    ...
                    <div class="form-group ">
                        <label for="content" class="col-sm-2 control-label">Menara Status </label>

                        <div class="col-sm-8">
                        <span class="detail_group-menara_status"><?= _ent($menara->menara_status); ?></span>
                        </div>
                    </div>
