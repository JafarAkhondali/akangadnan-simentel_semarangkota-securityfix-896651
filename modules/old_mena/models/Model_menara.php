...
class Model_menara extends MY_Model {
	...
	public $field_search 	= ['pemohon_id', 'kecamatan_id', 'kelurahan_id', 'tipesite_id', 'operator_id', 'menara_nama', 'menara_alamat', 'menara_rt', 'menara_rw', 'menara_file_berkas', 'menara_latitude', 'menara_longitude', 'menara_ketinggian', 'kawasan_id', 'menara_nama_penyewa', 'menara_pemilik', 'menara_kondisi', 'menara_luas_area', 'pemohon.pemohon_nama', 'kecamatan.kecamatan_nama', 'kelurahan.kelurahan_nama', 'tipe_site.tipe_site_nama', 'operator.operator_nama', 'kawasan.kawasan_nama'];
