...
class Menara extends Admin {
	public function __construct() {
		...
		$this->load->model('zona/model_zona');
	...
	*/
	public function add() {
		...
		$this->template->title('Menara Baru');
	...
	*/
	public function add_save() {
		...
		$this->form_validation->set_rules('menara_rt', 'RT', 'trim|required|max_length[5]');
		$this->form_validation->set_rules('menara_rw', 'RW', 'trim|required|max_length[5]');
		$this->form_validation->set_rules('menara_longitude', 'Longitude', 'trim|required|max_length[255]');
		$this->form_validation->set_rules('menara_ketinggian', 'Ketinggian Menara (m)', 'trim|required|max_length[255]');
		$this->form_validation->set_rules('menara_nama_penyewa', 'Nama Penyewa', 'trim|required|max_length[255]');
		$this->form_validation->set_rules('menara_pemilik', 'Pemilik Menara', 'trim|required|max_length[255]');
		$this->form_validation->set_rules('menara_kondisi', 'Kondisi', 'trim|required');
		$this->form_validation->set_rules('menara_luas_area', 'Luas Area', 'trim|required|max_length[255]');
		...
		if ($this->form_validation->run()) {
			...
			$save_data = [
				...
				'operator_id' => implode(',', (array) $this->input->post('operator_id')),
				...
				'menara_user_created' => $this->input->post('menara_user_created'),
				'menara_status' => $this->input->post('menara_status'),
				'menara_created_at' => $this->input->post('menara_created_at'),
