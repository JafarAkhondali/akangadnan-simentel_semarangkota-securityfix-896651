...
<section class="content-header">
	<h1>Kelurahan <small>Edit Kelurahan</small></h1>
	<ol class="breadcrumb">
		<li><a href="javascript:void(0);"><i class="fa fa-dashboard"></i> Home</a></li>
		<li><a href="<?= site_url('administrator/kelurahan'); ?>">Kelurahan</a></li>
			...
			?>
				...
				<div class="box-body">
						...
						<div class="form-group group-kelurahan-nama">
							...
							<input type="text" class="form-control" name="kelurahan_nama" id="kelurahan_nama" placeholder="" value="<?= set_value('kelurahan_nama', $kelurahan->kelurahan_nama); ?>">
...
<script>
	$(document).ready(function () {
		...
		function chained_kecamatan_id(selected, complete) {
			...
			$.LoadingOverlay('show');
			return $.ajax({
				url: BASE_URL + '/administrator/kelurahan/ajax_kecamatan_id/' + val,
				dataType: 'JSON',
			})
			.done(function (res) {
		...
		async function chain() {
			await chained_kecamatan_id("<?= $kelurahan->kecamatan_id ?>");
		}
